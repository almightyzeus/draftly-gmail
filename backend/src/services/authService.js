...
import { ValidationError, ConflictError, UnauthorizedError, NotFoundError, InternalServerError, } from '../utils/errors.js';
export class AuthService {
     ...
     */
    static validateRegisterInputs(name, email, password) {
        if (!name?.trim()) {
